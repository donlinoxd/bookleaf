...
export default function AiChatScreen() {
  ...
  if (phase === 'not-downloaded') {
    return (
      <View style={{ flex: 1, backgroundColor: '#F8FAF8', paddingTop: insets.top, paddingHorizontal: 24, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: 26, fontWeight: '700', color: BRAND, marginTop: 20, textAlign: 'center' }}>
          Meet Leaf AI
        </Text>
        ...
        <View style={{ backgroundColor: '#EFF6EF', borderRadius: 14, padding: 16, marginTop: 32, width: '100%', gap: 6 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            <Text style={{ fontSize: 13, color: '#1E293B' }}>Model: <Text style={{ fontWeight: '600' }}>Gemma 2 2B (Q4_K_M)</Text></Text>
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            <Ionicons name="download-outline" size={16} color={BRAND} />
            <Text style={{ fontSize: 13, color: '#1E293B' }}>One-time download: <Text style={{ fontWeight: '600' }}>~1.5 GB</Text></Text>
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
        ...
        <TouchableOpacity
          ...
          style={{ backgroundColor: LEAF, borderRadius: 16, paddingVertical: 16, paddingHorizontal: 48, marginTop: 32, elevation: 4, shadowColor: LEAF, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8 }}
        >
          <Text style={{ color: '#fff', fontSize: 16, fontWeight: '700' }}>Download Model</Text>
        </TouchableOpacity>
        <Text style={{ fontSize: 12, color: '#94A3B8', marginTop: 12, textAlign: 'center' }}>
    ...
    >
      ...
      <View style={{
        ...
        <View style={{
          ...
          backgroundColor: LEAF, alignItems: 'center', justifyContent: 'center', marginRight: 10,
        }}>
        ...
        ListEmptyComponent={
          <View style={{ alignItems: 'center', marginTop: 60, paddingHorizontal: 24 }}>
            ...
            <Text style={{ color: '#CBD5E1', marginTop: 6, fontSize: 13, textAlign: 'center' }}>
              Books, members, borrowing, reports…
            </Text>
          </View>
        }
        renderItem={({ item }) => (
          <View style={{
            ...
            <View style={{
              ...
              <Text style={{ color: item.role === 'user' ? '#fff' : '#1E293B', fontSize: 14, lineHeight: 21 }}>
                {item.content}
              </Text>
            </View>
          </View>
      ...
      <View style={{
        ...
        <TextInput
          ...
          placeholder="Ask about books, members, reports…"
          placeholderTextColor="#94A3B8"
          multiline
          style={{ flex: 1, fontSize: 14, color: '#1E293B', maxHeight: 100, paddingVertical: 4 }}
        ...
        >
          {isGenerating
            ...
            : <Ionicons name="send" size={16} color={input.trim() ? '#fff' : '#94A3B8'} />
          }
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
