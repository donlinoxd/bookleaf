...
export default function DashboardScreen() {
    const { currentUser, institutionId } = useAppStore()
    ...
    const loading = recentQuery.isLoading || popularQuery.isLoading || (!!currentUser && (borrowsQuery.isLoading || reservationsQuery.isLoading))
